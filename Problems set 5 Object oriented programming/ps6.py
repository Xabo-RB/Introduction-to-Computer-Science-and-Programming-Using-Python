...
class Message(object):
    ...
    def build_shift_dict(self, shift):
        ...
        lowerKeys = list(alfabeto)
        lowerValues = list(alfabeto)
        
        upperKeys = list(ALFABETO )                 
        upperValues = list(ALFABETO)
        
        #Move the values:
        #Create new list as: To put the Shift value on the first place    
        NewValues = lowerValues[shift:] + lowerValues[:shift]
        NewValuesUpper = upperValues[shift:] + upperValues[:shift]
        
        #The zip() function takes iterables (can be zero or more), aggregates
        #them in a tuple, and returns it. Like a zip type, then you can convert 
        #it with dict(), list(), ...
        
        Valuess = NewValues + NewValuesUpper
        Keyss = lowerKeys + upperKeys
        
        self.NewDict = dict(zip(Keyss,Valuess))
        return self.NewDict
